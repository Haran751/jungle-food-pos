        ...
        <Card ref={receiptRef}>
          <CardContent className="p-6">
            <div className="text-center space-y-1 mb-4">
              ...
              <p className="text-xs text-muted-foreground">
                Kasir: {lastTransaction.kasir.name || lastTransaction.kasir.username}
              </p>
            </div>

            <div className="separator border-t border-dashed" />
            ...
            <div className="space-y-1 mt-4">
              <div className="flex justify-between font-bold text-sm">
                <span>TOTAL</span>
                <span>{formatRp(lastTransaction.totalPrice)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Bayar</span>
                <span>{formatRp(lastTransaction.payment)}</span>
              </div>
              <div className="flex justify-between text-sm font-bold text-emerald-600 dark:text-emerald-400">
                <span>Kembalian</span>
                <span>{formatRp(lastTransaction.change)}</span>
              </div>
            </div>
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto">
                {cart.length === 0 ? (
                  <p className="text-center text-sm text-muted-foreground py-8">
                    Keranjang kosong. Klik menu untuk menambahkan.
                  </p>
                ) : (
                  cart.map((item) => (
